...
class GrammarQuiz extends StatelessWidget {
  @override
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          ...
          final c1 = messages[grammarquestionNo]['choices']['opt1'];
          final c2 = messages[grammarquestionNo]['choices']['opt2'];
          final c3 = messages[grammarquestionNo]['choices']['opt3'];
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Image.asset(
                      messages[grammarquestionNo]['image'],
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              Expanded(
                  child: Center(
                child: Text(
                  messages[grammarquestionNo]['question'],
              ...
              Expanded(
                child: Padding(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      isPressed = true;
                      checkAnswer(grammarquestionNo, 1);
              ...
              Expanded(
                child: Padding(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      isPressed = true;
                      checkAnswer(grammarquestionNo, 2);
                      new Timer(Duration(seconds: 1), () {
                        updateQuestion();
                      });
                      setState(() {
              ...
              Expanded(
                child: Padding(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      isPressed = true;
                      checkAnswer(grammarquestionNo, 3);
                      new Timer(Duration(seconds: 1), () {
                        updateQuestion();
                      });
                      setState(() {
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(
                      ...
                      width: 250.0,
                      child: Text(
                        'Congratulations! Your score is $finalresultG%',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 25.0,
