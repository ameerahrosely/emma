...
class IdiomOne extends StatefulWidget {
  @override
  _IdiomOneState createState() => _IdiomOneState();
}

class _IdiomOneState extends State<IdiomOne> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SafeArea(
          child: StreamBuilder(
              stream: _firestore.collection('notes-idiom').snapshots(),
              builder: (context, snapshot) {
                ...
                final theidiom = gnotes[notesNo]['idiom'];
                ...
                return Stack(
                  children: <Widget>[
                    ...
                    Positioned(
                        left: 50, top: 270, child: meaningContent(theidiom)),
                    Positioned(
                        left: 50,
                        top: 320,
